          ...
          <div className="actions">
            <div className="action donate">
              ...
              <div className="action-info">
                ...
                <p>Every donation made is appreciated more than you will ever know. Each donation plays a vital step in stabilising the hedgehog population, and giving them another chance at life.</p>
